...
{
    public partial class TechBooking : IRecognizerConvert
    {
        public string Text;
        ...
        {
            var app = JsonConvert.DeserializeObject<TechBooking>(JsonConvert.SerializeObject(result, new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore }));
            Text = app.Text;
